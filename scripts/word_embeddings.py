...
title_embeds = [nlp(raw_title).vector for raw_title in raw_titles]
...
desc_embeds = [nlp(raw_desc).vector for raw_desc in raw_descs]
...
df.drop(labels = ['cleaned_title, cleaned_description'], axis = 1, inplace = True)
